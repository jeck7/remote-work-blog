...
import homeBg from 'images/neon_light_circles_1920x1080.jpg';
...
class Header extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <Navbar className={cx("navbar", "navbar-expand-lg", "navbar-light", "fixed-top", "is-visible")}
                        id="mainNav">
                    <Container>
                        <Link className={cx("navbar-brand")} to="/">Remote Work Blog</Link>
