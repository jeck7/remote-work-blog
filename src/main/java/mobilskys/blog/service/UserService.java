...
import mobilskys.blog.common.util.AuthoritiesConstants;
import mobilskys.blog.model.domain.Authority;
import mobilskys.blog.model.domain.User;
import mobilskys.blog.model.dto.UserDto;
import mobilskys.blog.repository.AuthorityRepository;
...
public class UserService {
    ...
    public User registerAccountNew(UserDto userDto) {
        userRepository.findByEmail(userDto.getEmail())
                .ifPresent(user -> {
                    throw new ApiException("Email Already exists.", HttpStatus.BAD_REQUEST);
                });
